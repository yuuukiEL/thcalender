...
class PrivateChat(BaseModel):
    ...
    sender_id = db.Column(db.String(5), db.ForeignKey('students.student_id'), nullable=False, comment='送信者の生徒ID（students参照）')
    receiver_id = db.Column(db.String(5), db.ForeignKey('students.student_id'), nullable=False, comment='受信者の生徒ID（students参照）')
